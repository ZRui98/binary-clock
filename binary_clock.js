function startClock(){
    ...
    if(hours<10)
        ctx.fillText('0'+hours,w*0.04,w*0.14);
    else
        ctx.fillText(hours,w*0.04,w*0.14);
    if(minutes<10)
        ctx.fillText('0'+minutes,w*0.04,w*0.28);
    else
        ctx.fillText(minutes,w*0.04,w*0.28);

    if(seconds<10)
        ctx.fillText('0'+seconds,w*0.04,w*0.42);
    else
        ctx.fillText(seconds,w*0.04,w*0.42);
